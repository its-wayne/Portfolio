...
function sendEmail(event) {
  ...
  // Send to the Google Apps Script web app. FormData keeps it a "simple"
  // request (no CORS preflight); no-cors means we can't read the response,
  // so we treat a resolved fetch as success.
  ...
  fetch(CONTACT_ENDPOINT, { method: 'POST', mode: 'no-cors', body: formData })
    .then(function() {
    ...
    .catch(function(error) {
      ...
      showFormMessage('Sorry, there was a problem sending your message. Please email me directly at waynstanaung@berkeley.edu.', 'error');
    })
    .finally(function() {
